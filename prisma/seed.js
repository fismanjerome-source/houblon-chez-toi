...
const BEERS = [
  ...
  },
  {
    ...
    price33: 0,
    price75: 0,
    description: 'Délicate mais caractéristique, la Leffe Blonde 0,0% accompagne avec légèreté vos repas tout en gardant une vraie touche de saveur.',
    aroma: 'Fruitée, avec des notes de vanille et de clou de girofle.',
    taste: 'Notes légèrement fruitées, clou de girofle, vanille et une pointe fumée.',
    servingTemp: '5°C',
    brewHistory: "Bière d'abbaye dont la recette remonte à 1240, ici déclinée sans alcool.",
    learnMoreUrl: 'https://www.leffe.com/fr/beer?name=leffe-blonde-00',
    active: false,
  },
  {
    name: 'PVL Blonde',
